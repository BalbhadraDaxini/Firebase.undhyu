...
function WhatsAppIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path 
        fill="currentColor" 
        d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91c0 1.75.46 3.39 1.27 4.86l-1.34 4.91l5.04-1.32c1.4.79 3.01 1.25 4.72 1.25h.01c5.46 0 9.91-4.45 9.91-9.91s-4.45-9.91-9.91-9.91zm4.62 11.23c-.27-.14-1.61-.79-1.86-.88c-.25-.09-.43-.14-.62.14c-.19.27-.7.88-.86 1.06c-.16.18-.32.2-.59.07s-1.14-.42-2.17-1.34c-1.03-.92-1.73-2.06-2-2.4c-.27-.35-.01-.54.12-.68c.12-.12.27-.32.4-.48c.14-.17.18-.28.27-.47c.09-.19.05-.36-.02-.5s-.61-1.47-.84-2.02c-.23-.55-.46-.48-.62-.48c-.17 0-.36-.01-.54-.01s-.47.07-.7.34c-.23.28-.89 1.04-.89 2.52s.91 2.93 1.04 3.13c.13.2 1.78 2.72 4.31 3.8c.55.23 1.04.37 1.4.47c.6.17 1.15.14 1.58.09c.48-.06 1.61-.66 1.83-1.28c.23-.62.23-1.14.16-1.28c-.07-.13-.25-.21-.52-.35z"
      />
    </svg>
  );
}
